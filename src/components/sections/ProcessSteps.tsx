            ...
            {steps.map((step, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="bg-white rounded-2xl p-6 lg:p-8 border border-slate-100 hover:border-accent/20 hover:shadow-lg transition-all duration-300 relative z-10">
                    {/* Number Badge */}
